      ...
      <div className="hidden md:flex md:col-span-5 relative bg-surface border-r border-line p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-xl text-ink leading-relaxed font-display font-medium italic">
            "We wanted a simple way to clip episodes without paying thousands to agencies. ClipForge does the work of an entire post-production team in less than 5 minutes."
          </p>
          <div>
            <h4 className="font-bold text-ink text-sm">Alex Rivera</h4>
            <p className="text-xs text-ink-dim">Host, Founders & Creators Podcast</p>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-3.5 border-t border-line/60 pt-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-ink-dim font-medium">Free credits for your first episode</span>
          </div>
          <div className="flex items-center gap-3">
            <svg className="w-4 h-4 text-lime" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
            <span className="text-xs text-ink-dim font-medium">Portrait (9:16) rendering in HD</span>
          </div>
          <div className="flex items-center gap-3">
            <svg className="w-4 h-4 text-lime" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            </svg>
            <span className="text-xs text-ink-dim font-medium">Automatic hook categorization</span>
          </div>
        </div>
      </div>
      ...
      <div className="col-span-12 md:col-span-7 flex flex-col justify-center px-6 sm:px-16 md:px-24 py-12 relative">
        ...
        <div className="max-w-md w-full mx-auto space-y-6 animate-slide-up">
          <div>
            ...
            <h1 className="font-display text-3xl font-bold tracking-tight">Create your workspace</h1>
            <p className="text-sm text-ink-dim mt-2">
              Set up your show, upload raw media, and generate storyboards.
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <label className="block text-sm">
              <span className="text-ink-dim mb-1 block font-medium">Workspace name (show or agency)</span>
              <input
                required
                type="text"
                ...
                className="w-full border border-line rounded-lg px-4 py-2.5 bg-surface focus:border-lime focus:ring-1 focus:ring-lime outline-none transition-all placeholder:text-ink-dim/40 text-sm"
              />
            </label>

            <label className="block text-sm">
              <span className="text-ink-dim mb-1 block font-medium">Your Full Name</span>
              <input
                required
                type="text"
            ...
            <label className="block text-sm">
              <span className="text-ink-dim mb-1 block font-medium">Email Address</span>
              <input
                required
                type="email"
            ...
            <label className="block text-sm relative">
              <span className="text-ink-dim mb-1 block font-medium">Password</span>
              <div className="relative">
                <input
                  ...
                  className="w-full border border-line rounded-lg pl-4 pr-12 py-2.5 bg-surface focus:border-lime focus:ring-1 focus:ring-lime outline-none transition-all placeholder:text-ink-dim/40 text-sm"
                />
                <button
                  type="button"
            ...
            {error && (
              <div className="bg-coral-bg/30 border border-coral/30 text-coral text-xs p-3 rounded-lg flex items-center gap-2">
